...
export default function Page(){
  return(
      ...
      <div className="bg-white mx-8 pt-8 rounded-lg translate-y-12">
        <div className=" justify-between">
          <div className="flex justify-between px-5">
            ...
            <div className=" rounded-lg py-0 pl-1 pb-8">
              <div className="bg-[#D28F32] ml-2 flex py-2 pl-1 pr-8 rounded-lg gap-1">
          ...
          <div className="bg-[#D9D9D9]  w-full  items-center rounded-lg py-2 flex justify-between px-5">
            <div className="flex items-center gap-1 ">
              <Image src="/svg/pesanan.svg" alt="pesanan" width={28} height={28.88} />
              <p>Pesanan</p>
            </div>
            <div className="flex items-center gap-1">
              <Image src="/svg/riwayat.svg" alt="riwayat" width={24.5} height={24.5} />
              <p>Riwayat Pesanan</p>
            </div>
          </div>
    ...
    <div className="pt-14 grid grid-cols-3 items-center px-16 gap-x-16 gap-y-7 pb-24">
        ...
        <div className="flex flex-col items-center gap-3">
          <Image src="/images/menu-minuman.png" alt="menu makanan" width={64} height={64}  />
          <p className="text-sm font-medium text-[#474747]">Minuman</p>
        </div>
        <div className="flex flex-col items-center gap-3">
          <Image src="/images/menu-favorite.png" alt="menu makanan" width={64} height={64}  />
          <p className="text-sm font-medium text-nowrap text-[#474747]">Menu Favorite</p>
        </div>
        <div className="flex flex-col items-center gap-3">
          <Image src="/images/menu-kelola.png" alt="menu makanan" width={64} height={64}  />
          <p className="text-sm font-medium text-nowrap text-[#474747]">Kelola Menu</p>
        </div>
        <div className="flex flex-col items-center gap-3">
          <Image src="/images/status-pembayaran.png" alt="menu makanan" width={64} height={64}  />
          <p className="text-sm font-medium text-center text-[#474747]">Status Pembayaran</p>
        </div>
        <div className="flex flex-col items-center gap-3">
          <Image src="/images/menu-lainnya.png" alt="menu makanan" width={64} height={64}  />
