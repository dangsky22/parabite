...
export default function Page() {
  ...
  // Filter data untuk menampilkan hanya menu dengan kategori "makanan"
  const foodMenus = menus.filter(menu => menu.kategori === "makanan");
  ...
  return (
    <div className="font-sans bg-gray-100 min-h-screen w-full">
      ...
      <div className="p-5">
        ...
        {/* Menampilkan Menu dengan data dari API */}
        {!loading && !error && foodMenus.length > 0 ? (
          foodMenus.map((menu) => (
            <MenuCard
              key={menu.id}
              image={menu.image}
